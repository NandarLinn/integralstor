...
def get_status(ip):
    ...
    try:
        ...
        if 'interfaces' in data:
            for interface_name, interface_info in list(data['interfaces'].items()):
                interface_dict = {}
        ...
        disks = []
        if 'disks' in data:
            for disk_name, disk_info in list(data['disks'].items()):
                disk_dict = {}
        ...
        services = []
        if 'services' in data:
            for service_name, service_info in list(data['services'].items()):
                service_dict = {}
